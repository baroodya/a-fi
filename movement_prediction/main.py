...
for row in table.findAll("tr")[1:num_ticker_symbols]:
...
architectures = [createBasicModel, createDeepModel]

for architectureFunction in architectures:
        ...
        for batch_size in training_batch_sizes:
            for epochs in epochs_arr:
                ...
                model = AFiMovementModel(
                    num_features, loss_fn, architectureFunction).to(device)
